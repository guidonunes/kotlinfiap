...
fun AddReviewScreen(navController: NavHostController?) {
    ...
    val difficultyLevelList = listOf(
    ...
    var difficultyLevel by remember {
        mutableStateOf(difficultyLevelList[0])
    }
    ...
    Box(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "Before anything else, let's define the basic data of your review.",
                    color = MaterialTheme.colorScheme.primary,
                ...
                OutlinedTextField(
                    ...
                    placeholder = {
                        Text(text = "A brief review of the game")
                    },
                    maxLines = 6
                )
                ...
                Column(
                    ...
                    difficultyLevelList.forEach { level ->
                        Row(
                            verticalAlignment = Alignment.CenterVertically,
                            modifier = Modifier
                                .height(40.dp)
